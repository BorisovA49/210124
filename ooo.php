...
<div class="list-group">
    ...
    foreach ($lvl1 as $brow) {
        foreach ($lvl2 as $kubrow) {
            if ($kubrow["parid"] == $brow["id"]){print('<div class="modal fade" id="exampleModal' . $kubrow['id'] . '" tabindex="-1" aria-labelledby="exampleModalLabel' . $kubrow['id'] . '" aria-hidden="true">
